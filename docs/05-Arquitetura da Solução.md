...
A Hospedagem do site foi feita usando a plataforma Azure, o deploy é feito de maneira automática utilizando   
o GitHub Actions, que faz o build, deploy e disponibiliza a aplicação no Link https://jobs-pucminas.azurewebsites.net/.
